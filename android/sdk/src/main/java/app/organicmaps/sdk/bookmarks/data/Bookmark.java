...
public class Bookmark extends MapObject
{
  ...
  public Bookmark(@NonNull FeatureId featureId, @IntRange(from = 0) long categoryId,
                  ...
                  @OpeningMode int openingMode, @NonNull Popularity popularity, @Nullable Float starRating, int reviewCount,
                  @Nullable String reviewEditorAppName, @NonNull String wikiArticle, @NonNull String osmDescription, @Nullable String[] rawTypes)
  {
    super(featureId, BOOKMARK, title, secondaryTitle, subtitle, address, 0, 0, "", routePointInfo, openingMode,
        popularity, starRating, reviewCount, reviewEditorAppName, wikiArticle, osmDescription, RoadWarningMarkType.UNKNOWN.ordinal(), rawTypes);
