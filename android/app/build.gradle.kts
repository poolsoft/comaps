...
android {
    ...
    defaultConfig {
        ...
        ndk {
            ...
            val targetAbis = mutableSetOf<String>()
            if (project.hasProperty("arm32") || project.hasProperty("armeabi-v7a")) {
                targetAbis.add("armeabi-v7a")
            }
    ...
    productFlavors {
        ...
        create("carlauncher") {
            ...
            val autoVersionName = project.findProperty("autoVersionName") as? String
            val autoVersionCode = project.findProperty("autoVersionCode") as? String
            versionName = "${autoVersionName ?: android.defaultConfig.versionName!!}-Auto"
            if (autoVersionCode != null) {
                versionCode = autoVersionCode.toInt()
            }
            buildConfigField("String", "SUPPORT_MAIL", "\"auto@comaps.app\"")
            resValue("string", "app_name", "CoMaps Auto")
        }
    }
    ...
    buildTypes {
        ...
        debug {
            ...
            if (taskName.contains("carlauncher")) {
                resValue("string", "app_name", "CoMaps Auto Debug")
            } else {
...
dependencies {
    "carlauncherImplementation"("com.alphacephei:vosk-android:0.3.47") {
        exclude(group = "net.java.dev.jna", module = "jna")
    }
    "carlauncherImplementation"("net.java.dev.jna:jna:5.13.0@aar")
