...
public class NavigationWidget extends BaseWidget implements TelemetryManager.TelemetryListener {
    ...
    public NavigationWidget(@NonNull Context context, @NonNull MwmApplication app) {
        super(context, "navigation", context.getString(R.string.car_widget_navigation));
        this.app = app;
    ...
    public View createView() {
        ...
        label.setText(context.getString(R.string.car_widget_nav_label));
    ...
    private void showNoNavigation() {
        ...
        if (instructionText != null) instructionText.post(() -> instructionText.setText(context.getString(R.string.car_widget_nav_no_navigation)));
