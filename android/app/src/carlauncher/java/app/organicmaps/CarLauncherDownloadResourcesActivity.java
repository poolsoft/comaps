...
public class CarLauncherDownloadResourcesActivity extends BaseMwmFragmentActivity
{
  private static final String TAG = CarLauncherDownloadResourcesActivity.class.getSimpleName();
  ...
  private final LocationListener mLocationListener = new LocationListener() {
    ...
    public void onLocationUpdated(@NonNull Location location)
    {
      ...
      MwmApplication.from(CarLauncherDownloadResourcesActivity.this).getLocationHelper().removeListener(this);
    }
  };
    ...
    public void onStatusChanged(List<MapManager.StorageCallbackData> data)
    {
      for (MapManager.StorageCallbackData item : data)
      {
        ...
        case CountryItem.STATUS_FAILED:
          MapManagerHelper.showError(CarLauncherDownloadResourcesActivity.this, item, null);
          return;
        }
      }
    }
  ...
  public void showMap()
  {
    ...
    intent.setComponent(new ComponentName(
        this, app.organicmaps.carlauncher.CarLauncherActivity.class));

    // Download tamamlandiginda standart CoMaps ekrani yerine launcher'a don.
