...
UNIT_TEST(ClampAngle)
{
  TEST(is_equal_angle(ang::ClampAngle(math::pi4, math::pi4, math::pi2), math::pi4), ());

  TEST(is_equal_angle(ang::ClampAngle(0.2 * math::pi, math::pi, math::pi2), math::pi2), ());
  TEST(is_equal_angle(ang::ClampAngle(1.8 * math::pi, math::pi, math::pi2), math::pi + math::pi2), ());

  TEST(is_equal_angle(ang::ClampAngle(math::pi, math::pi4, 0.0), math::pi4), ());
  TEST(is_equal_angle(ang::ClampAngle(2.0 * math::pi, math::pi, math::pi), 0.0), ());
}
