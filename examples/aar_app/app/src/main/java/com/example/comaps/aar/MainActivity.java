...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Defer fragment creation until OrganicMaps is initialized so LocationHelper is
        // available.

        // Initialize OrganicMaps and create fragment after initialization completes
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            app.initOrganicMaps(new com.example.comaps.aar.DummyLocationProviderFactory(), onComplete);
        }
